...
#                     continue
            ...
            #     show_video(PATH_TO_VIDEO_ON_YOUR_DRIVE)
                ...
                f.write("{},{},{},{}\n".format(fname, pred_period, pred_score.numpy(), chosen_stride))
        #         df.loc[i] = [fname, pred_period, pred_score.numpy(), within_period, per_frame_counts, chosen_stride]
                f.flush
                for idx,w in enumerate(within_period):
                    g.write("{},{},{}\n".format(fname,idx,w))
                g.flush
                for idx,w in enumerate(per_frame_counts):
                    h.write("{},{},{}\n".format(fname,idx,w))
                h.flush
