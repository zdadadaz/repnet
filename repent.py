...
PATH_TO_VIDEO_ON_YOUR_DRIVE = "./../../data/EchoNet-Dynamic/Videos/0X22E82C3D081C819C.avi"
...
df = pd.DataFrame({"pred_period": [1], "pred_score": [1], "within_period":[[1,1,1,1]], 'per_frame_counts':[[1,1,1,1]], 'chosen_stride':[1]})
df.loc[1] = [pred_period, pred_score.numpy(), within_period, per_frame_counts, chosen_stride]
# print("pred_period: ", pred_period) 
# print("pred_score: ", pred_score.eval())
# print("within_period: ", within_period.shape)
# print("within_period: ", within_period)
# print("per_frame_counts: ", per_frame_counts.shape)
